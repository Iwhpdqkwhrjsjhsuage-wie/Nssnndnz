...
local Themes = {
  ...
  Navy = {
    Name = "Navy",
    Accent = Color3.fromRGB(0, 105, 148),  -- น้ำเงินเข้ม
    AcrylicMain = Color3.fromRGB(20, 30, 50),  -- พื้นหลังสีเข้ม
    AcrylicBorder = Color3.fromRGB(35, 55, 75),  -- ขอบสีเข้ม
    AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 20, 35), Color3.fromRGB(25, 40, 60)),  -- เกรเดียนต์น้ำเงินเข้ม
    AcrylicNoise = 0.9,
    TitleBarLine = Color3.fromRGB(25, 40, 60),  -- บาร์หัวข้อสีน้ำเงินเข้ม
    Tab = Color3.fromRGB(50, 70, 90),  -- สีของแท็บ
    Element = Color3.fromRGB(40, 60, 80),  -- สีของแต่ละส่วน
    ElementBorder = Color3.fromRGB(50, 75, 100),  -- ขอบของส่วนต่างๆ
    InElementBorder = Color3.fromRGB(55, 85, 110),  -- ขอบในส่วน
    ElementTransparency = 0.88,
    ToggleSlider = Color3.fromRGB(75, 100, 130),  -- สีของสไลเดอร์
    ToggleToggled = Color3.fromRGB(15, 25, 35),  -- สีของ toggle ที่ถูกเปิด
    SliderRail = Color3.fromRGB(75, 100, 130),  -- สีของรางสไลเดอร์
    DropdownFrame = Color3.fromRGB(90, 130, 160),  -- สีของกรอบ dropdown
    DropdownHolder = Color3.fromRGB(25, 40, 55),  -- สีของพื้นหลัง dropdown
    DropdownBorder = Color3.fromRGB(50, 75, 100),  -- ขอบของ dropdown
    DropdownOption = Color3.fromRGB(75, 100, 130),  -- ตัวเลือกใน dropdown
    Keybind = Color3.fromRGB(75, 100, 130),  -- สีของ keybind
    Input = Color3.fromRGB(75, 100, 130),  -- สีของ input box
    InputFocused = Color3.fromRGB(20, 30, 50),  -- สีของ input เมื่อโฟกัส
    InputIndicator = Color3.fromRGB(100, 150, 200),  -- ตัวบ่งชี้ใน input
    InputIndicatorFocus = Color3.fromRGB(0, 105, 148),  -- ตัวบ่งชี้ใน input เมื่อโฟกัส
    Dialog = Color3.fromRGB(25, 40, 55),  -- สีพื้นหลังของ dialog
    DialogHolder = Color3.fromRGB(15, 25, 40),  -- สีของพื้นที่ใน dialog
    DialogHolderLine = Color3.fromRGB(10, 20, 35),  -- ขอบใน dialog
    DialogButton = Color3.fromRGB(25, 40, 55),  -- สีของปุ่มใน dialog
    DialogButtonBorder = Color3.fromRGB(35, 50, 70),  -- ขอบของปุ่มใน dialog
    DialogBorder = Color3.fromRGB(30, 45, 65),  -- ขอบของ dialog
    DialogInput = Color3.fromRGB(30, 50, 70),  -- สีของ input ใน dialog
    DialogInputLine = Color3.fromRGB(90, 130, 160),  -- ขอบของ input ใน dialog
    Text = Color3.fromRGB(240, 250, 255),  -- สีของข้อความหลัก
    SubText = Color3.fromRGB(180, 200, 220),  -- สีของข้อความรอง
    Hover = Color3.fromRGB(75, 100, 130),  -- สีของ hover
    HoverChange = 0.05  -- การเปลี่ยนแปลงเมื่อ hover
  },
    CandySunset = {
    	Name = "CandySunset",
    	Accent = Color3.fromRGB(255, 150, 200), -- ชมพูหวาน
    	AcrylicMain = Color3.fromRGB(255, 220, 200), -- พีชอ่อน
    	AcrylicBorder = Color3.fromRGB(255, 180, 170),
    	AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 200, 180), Color3.fromRGB(255, 180, 160)),
    	AcrylicNoise = 0.4,
    	TitleBarLine = Color3.fromRGB(255, 180, 190),
    	Tab = Color3.fromRGB(255, 170, 190),
    	Element = Color3.fromRGB(255, 180, 210),
    	ElementBorder = Color3.fromRGB(240, 140, 170),
    	InElementBorder = Color3.fromRGB(255, 160, 190),
    	ElementTransparency = 0.8,
    	ToggleSlider = Color3.fromRGB(255, 160, 190),
    	ToggleToggled = Color3.fromRGB(255, 200, 220),
    	SliderRail = Color3.fromRGB(255, 180, 200),
    	DropdownFrame = Color3.fromRGB(255, 220, 240),
    	DropdownHolder = Color3.fromRGB(255, 190, 220),
    	DropdownBorder = Color3.fromRGB(240, 140, 170),
    	DropdownOption = Color3.fromRGB(255, 200, 230),
    	Keybind = Color3.fromRGB(255, 190, 220),
    	Input = Color3.fromRGB(255, 210, 240),
    	InputFocused = Color3.fromRGB(255, 230, 250),
    	InputIndicator = Color3.fromRGB(255, 160, 200),
    	Dialog = Color3.fromRGB(255, 220, 240),
    	DialogHolder = Color3.fromRGB(255, 200, 230),
    	DialogHolderLine = Color3.fromRGB(255, 170, 210),
    	DialogButton = Color3.fromRGB(255, 190, 230),
    	DialogButtonBorder = Color3.fromRGB(240, 140, 170),
    	DialogBorder = Color3.fromRGB(240, 140, 170),
    	DialogInput = Color3.fromRGB(255, 210, 230),
    	DialogInputLine = Color3.fromRGB(255, 160, 200),
    	Text = Color3.fromRGB(100, 20, 60), -- น้ำตาลแดง
    	SubText = Color3.fromRGB(150, 60, 100),
    	Hover = Color3.fromRGB(255, 180, 220),
    	HoverChange = 0.05,
    },
    Verdant = {
    	Name = "Verdant",
    	Accent = Color3.fromRGB(0, 200, 120), -- เขียวสด
    	AcrylicMain = Color3.fromRGB(20, 40, 30), -- เขียวเข้ม
    	AcrylicBorder = Color3.fromRGB(30, 60, 45),
    	AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 60, 45), Color3.fromRGB(20, 40, 30)),
    	AcrylicNoise = 0.5,
    	TitleBarLine = Color3.fromRGB(40, 80, 60),
    	Tab = Color3.fromRGB(0, 180, 100),
    	Element = Color3.fromRGB(30, 90, 60),
    	ElementBorder = Color3.fromRGB(10, 30, 20),
    	InElementBorder = Color3.fromRGB(40, 100, 70),
    	ElementTransparency = 0.8,
    	ToggleSlider = Color3.fromRGB(0, 160, 100),
    	ToggleToggled = Color3.fromRGB(0, 90, 50),
    	SliderRail = Color3.fromRGB(0, 140, 90),
    	DropdownFrame = Color3.fromRGB(40, 100, 70),
    	DropdownHolder = Color3.fromRGB(20, 60, 40),
    	DropdownBorder = Color3.fromRGB(10, 30, 20),
    	DropdownOption = Color3.fromRGB(0, 160, 100),
    	Keybind = Color3.fromRGB(0, 160, 100),
    	Input = Color3.fromRGB(50, 110, 80),
    	InputFocused = Color3.fromRGB(0, 80, 50),
    	InputIndicator = Color3.fromRGB(0, 180, 110),
    	Dialog = Color3.fromRGB(30, 70, 50),
    	DialogHolder = Color3.fromRGB(20, 60, 40),
    	DialogHolderLine = Color3.fromRGB(10, 30, 20),
    	DialogButton = Color3.fromRGB(30, 90, 60),
    	DialogButtonBorder = Color3.fromRGB(0, 120, 70),
    	DialogBorder = Color3.fromRGB(0, 100, 60),
    	DialogInput = Color3.fromRGB(30, 90, 60),
    	DialogInputLine = Color3.fromRGB(0, 160, 100),
    	Text = Color3.fromRGB(200, 255, 220), -- ขาวอมเขียว
    	SubText = Color3.fromRGB(140, 200, 170),
    	Hover = Color3.fromRGB(0, 200, 120),
    	HoverChange = 0.06,
    }
...
Components.TitleBar = (function()
	...
	return function(Config)
		...
		-- Minimize Button
		TitleBar.MinButton = BarButton(Components.Assets.Min, UDim2.new(1, -40, 0, 4), TitleBar.Frame, function() -- -80
	...
	return function(Config)
		...
		TitleBar.Frame = New("Frame", {
			...
			New("Frame", {
				...
				-- Logo Section
				New("ImageLabel", {
					Image = "rbxassetid://121794676391296",
					Size = UDim2.fromOffset(Config.LogoSize or 24, Config.LogoSize or 24),
					BackgroundTransparency = 1,
					LayoutOrder = 0,
					Name = "Logo",
...
Components.Window = (function()
	...
	return function(Config)
		...
		uicon = nevcitButton.MouseButton1Click:Connect(function()
			...
			elseif not Window.Root.Visible then
